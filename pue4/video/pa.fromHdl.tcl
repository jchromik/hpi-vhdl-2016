...
create_project -name video -dir "/mnt/Daten/Dokumente/studium/vhdl/hpi-vhdl-2016/pue4/video/planAhead_run_3" -part xc7a100tcsg324-1
...
set_property file_type VHDL $hdlfile
set_property library work $hdlfile
set hdlfile [add_files [list {video_out.vhd}]]
set_property file_type VHDL $hdlfile
set_property library work $hdlfile
